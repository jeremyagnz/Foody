  ...
  return (
    <div className="card">
      ...
      <div className="macros">
        <MacroBar label="Protein" value={protein} total={totalMacros} colorClass="protein" />
        <MacroBar label="Carbs" value={carbs} total={totalMacros} colorClass="carbs" />
        <MacroBar label="Fat" value={fat} total={totalMacros} colorClass="fat" />
      </div>
      ...
      {open && (
        <div className="details-panel">
          <div>
            <p className="details-section-title">Ingredients</p>
          ...
          <div>
            <p className="details-section-title">Instructions</p>
